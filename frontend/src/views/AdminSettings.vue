            ...
            <div style="overflow: hidden">
                <div id="profile" class="row">
                    ...
                    <div class="col-4 text-muted navigation-links">
                        <div class="icon-wrapper" :class="{ active: form_index === 0 }"
                            @click="form_index = 0; v$.user_name.$reset()">
                            <i class="ri-pencil-fill"></i> <span> Edit Profile </span>
                        </div>
                        <div class="icon-wrapper" :class="{ active: form_index === 1 }"
                            @click="form_index = 1; v$.password.$reset()">
                    ...
                    <div class="form-view p-3 col-8">
                        ...
                        <form class="form" @submit.prevent="handleSubmitProfile" v-else-if="form_index === 0">
                            ...
                            <div class="mb-3 w-50" :class="{ 'form-group--error': v$.user_name.$error }">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control " v-model="user_name" v-model.trim="v$.user_name.$model"
                                        :class="{ 'is-invalid': v$.user_name.$error }" v-bind:min="user_name"
                        ...
                        <form class="form" @submit.prevent="handleSubmitPassword" v-else-if="form_index === 1">
                            ...
                            <div class="mb-3 w-50" :class="{ 'form-group--error': v$.password.oldpassword.$error }">
                                ...
                                <div class="d-flex align-items-center">
                                    <input v-model="password.oldpassword" v-model.trim="v$.password.oldpassword.$model"
                                    ...
                                    <i style="margin-left: -25px; cursor: pointer"
                                        :class="['bi bi-' + eyeType[0], { 'ml-50': v$.password.oldpassword.$error }]"
                                        @click="toggleShow(0)"></i>
                            ...
                            <div class="mb-3" :class="{ 'form-group--error': v$.password.password.$error }">
                                ...
                                <div class="d-flex align-items-center w-50">
                                    <input class="form-control" v-model="password.password"
                                        ...
                                        v-bind:min="password.password" placeholder="New Password" :type="show[1]" />
                                    <i style="margin-left: -25px; cursor: pointer"
                                        :class="['bi bi-' + eyeType[1], { 'ml-50': v$.password.password.$error }]"
                                        @click="toggleShow(1)"></i>
                                    <!-- <b-icon
                                        style="margin-left: -25px; cursor: pointer" :icon="eyeType[1]"
                                        :class="{ 'ml-50': v$.password.password.$error }" @click="toggleShow(1)"></b-icon> -->
                                </div>
                            ...
                            <div class="mb-3" :class="{
                                ...
                                <div class="d-flex align-items-center w-50 ">
                                    <input v-model.trim="v$.password.confirmPassword.$model"
                                        :class="{ 'is-invalid': v$.password.confirmPassword.$error }"
                                        placeholder="Re-enter New Password" class="form-control" :type="show[2]" />
                                    <i style="margin-left: -25px; cursor: pointer"
                                        :class="['bi bi-' + eyeType[2], { 'ml-50': v$.password.confirmPassword.$error }]"
                                        @click="toggleShow(2)"></i>
