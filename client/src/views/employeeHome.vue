      ...
      <div id="start" class="carousel-inner">
        ...
        <div class="carousel-item active" data-bs-interval="2000">
          <img
            ...
            class="h-100 d-block w-100" alt="...">


          <div class="carousel-caption d-md-block " style="background:rgba(0, 0, 0, 0.562)">
            <h1> GYM TimeX </h1>
        ...
        <div class="carousel-item" data-bs-interval="2000">
          <img src="../assets/colousel1.jpg" class="d-block w-100 h-100" alt="...">
          <div class="carousel-caption d-md-block " style="background:rgba(0, 0, 0, 0.562)">
            <h1> GYM TimeX </h1>
        ...
        <div class="carousel-item" data-bs-interval="2000">
          <img src="../assets/carousel3.jpg" class="d-block h-100 w-100" alt="...">
          <div class=" carousel-caption  d-md-block " style="background:rgba(0, 0, 0, 0.562)">
            <h1> GYM TimeX </h1>
